            ...
            <div>
              ...
              <div className="mt-[30px] lg:mt-[55px] flex flex-col sm:flex-row lg:items-center gap-4 lg:gap-[30px]">
                <div>
                  ...
                  <p className="text_para mt-2 text-[1rem]">
                    Years of Experience
                  </p>
                </div>
                <div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[80px] lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="flex flex-col items-center justify-center">
              ...
              <div className="text-[26px] leading-9 text-headingColor font-[700] text-center mt-[2rem]">
                Find a Doctor
              </div>
      ...
      <section className="lg:pt-[60px]">
        <div className="container">
          <div className="max-w-[470px] mx-auto">
            ...
            <p className="text_para text-center pb-0">
              World-class care for everyone. Our health System offers unmatched,
              expert healthcare.
            </p>
          </div>
