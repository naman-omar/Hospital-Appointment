    ...
    return (
        <section className=" pt-[30px] sm:pt-[45px]"> 
            <div className="px-4 mx-auto max-w-[570px] md:max-w-[692px]">
                <h2 className="text-headingColor font-bold text-center text-[36px]">Contact Us</h2>
                ...
                <form action="#">
                    ...
                    <div className="mb-5">
                        ...
                        <textarea name="message" id="message" placeholder="Leave a comment..." className="form_input mt-1" rows="6"></textarea>
                    </div>
                    <button className="bg-primaryColor text-white text-[600] text-[18px] md:text-[20px] px-6 md:px-8 py-3 rounded">Submit</button>
                </form>
            </div>
        </section>
    );
