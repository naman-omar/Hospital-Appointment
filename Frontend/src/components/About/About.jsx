        ...
        <div className="flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2">
            ...
            <p className="text_para">
              For 30 years in a row, U.S. News & World Report has recoginzed us
              Texas. Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Ab optio dolores atque ad magni sequi quam.
            </p>
            <p className="text_para mt-[30px]">
              ...
              consectetur adipisicing elit. Saepe dolores architecto vitae
              aspernatur?{" "}
            </p>
            <Link to="/">
